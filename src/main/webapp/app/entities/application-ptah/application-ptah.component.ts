...
@Component({
    selector: 'jhi-application-ptah',
    templateUrl: './application-ptah.component.html'
})
export class ApplicationPtahComponent implements OnInit, OnDestroy {

    applications: ApplicationPtah[];
    currentAccount: any;
    ...
    trackId(index: number, item: ApplicationPtah) {
        return item.id;
    }
    registerChangeInApplications() {
        this.eventSubscriber = this.eventManager.subscribe('applicationListModification', (response) => this.reset());
    }
