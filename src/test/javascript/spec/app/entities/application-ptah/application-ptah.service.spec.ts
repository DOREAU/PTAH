...
describe('Service Tests', () => {
    ...
    describe('ApplicationPtah Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ApplicationPtahService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ApplicationPtah', () => {

                let entity: ApplicationPtah;
                service.find(123).subscribe((_entity: ApplicationPtah) => {
                    entity = _entity;
                });
